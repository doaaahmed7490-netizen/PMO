...
@Component({
  selector: 'app-List-ProjectCategory',
  templateUrl: './List-ProjectCategory.component.html',
  styleUrls: ['./List-ProjectCategory.component.css']
})
export class ListProjectCategoryComponent implements OnInit {
   tableData = [
    {  type: 'مشاريع الإنشاءات', notes: 'مشاريع البناء والبنية التحتية' },
     {  type: 'مشاريع تقنية المعلومات', notes: 'مشاريع الأنظمة والتطبيقات'  },

     {  type: 'مشاريع استشارية', notes: 'تقديم خدمات واستشارات'  },
  ];
 // dir = "ltr";
    dir = "rtl";
 ...
 {  type: 'مشاريع الإنشاءات', notes: 'مشاريع البناء والبنية التحتية' },
     ...
     {  type: 'مشاريع صيانة', notes: 'صيانة المبانى'  },
  ];
...
*/
  ...
  {
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/Country/list/';
  ...
  {
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/ProjectCategory/add';
