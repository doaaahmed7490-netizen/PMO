...
export class ListTransactionComponent implements OnInit {
   tableData = [
    {  code: '2533', Desc: 'إستخراج التصاريح',Categ:'رخص البناء',AgencyType:'عميل',Agency:'امانة جدة',StartDate:'26/3/2026',EndDate:'',Status:'تم التخطيط لها' },
    {  code: '2534', Desc: ' إعداد مخططات هندسية',Categ:'قررات مساحية',AgencyType:'مواطن',Agency:'دعاء احمد',StartDate:'22/3/2026',EndDate:'24/3/2026',Status:'مكتملة' },
...
*/
  ...
  {
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/IndependentTasks/list/';
  ...
  {
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/IndependentTasks/add';
 ...
 edit(row: any) {
  ...
  ShowEdit(id:string)
  {
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/Currency/edit/'+id;
