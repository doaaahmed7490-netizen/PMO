...
@Component({
  selector: 'app-List-CurrencyPricing',
  templateUrl: './List-CurrencyPricing.component.html',
  styleUrls: ['./List-CurrencyPricing.component.css']
})
export class ListCurrencyPricingComponent implements OnInit {
   tableData = [
    {  type: 'الريال', notes: 'الجنية المصرى',price:'13',date:'25/3/2026' },
    {  type: 'الريال', notes: 'الجنية المصرى',price:'13',date:'25/3/2026' },
...
*/
  ...
  {
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/Currency/list/';
  ...
  {
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/Currency/add';
