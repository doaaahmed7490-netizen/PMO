...
import { CurrencyPricingRoutingModule } from './CurrencyPricing-routing.module';

@NgModule({
  // declarations: [ListBlockLawsComponent, AddLetterTypeComponent, EditBlockLawComponent],
  declarations: [
    ListCurrencyPricingComponent,
    AddCurrencyPricingComponent
  ],

  imports: [
    CurrencyPricingRoutingModule,
    NbCardModule,
    NbButtonModule,
    NbInputModule,
    CommonModule,
...
export class CurrencyPricingModule { }
