...
export class ListStateComponent implements OnInit {
   tableData = [
    {  type: 'السعودية', notes: 'جدة' },
     {  type: 'السعودية', notes: 'الرياض'  },

     {  type: 'السعودية', notes: 'الطائف'  },
     {  type: 'السعودية', notes: 'تبوك'  },
       {  type: 'مصر', notes: 'القاهرة'  },
     {  type: 'مصر', notes: 'شرم الشيخ'  },
  ];
 // dir = "ltr";
    dir = "rtl";
...
*/
  ...
  {
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/State/add';
