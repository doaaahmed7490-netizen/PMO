...
@Component({
  selector: 'app-Add-ProjectMilestones',
  templateUrl: './Add-ProjectMilestones.component.html',
  styleUrls: ['./Add-ProjectMilestones.component.css']
})
export class AddProjectMilestonesComponent implements OnInit {
  constructor(
...
weight:[""],
  ...
  */
   ...
   onSubmit()
 {
   const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/ProjectMilestones';
