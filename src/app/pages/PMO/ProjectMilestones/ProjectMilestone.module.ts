...
import { ProjectCategoryRoutingModule } from '../ProjectCategory/projectcategory-routing.module';
import { ProjectMilestonesRoutingModule } from './ProjectMilestones-routing.module';
...
@NgModule({
  ...
  declarations: [
    ListProjectMilestonesComponent,
    AddProjectMilestonesComponent
  ],
