...
export class ListEmployeesComponent implements OnInit {
   tableData = [
      {  name: 'محمد محمد',jobname:'مهندس مدنى', mobil: '0564801300', email: 'm.mohamed@assar.sa', birthDate: '1/1/1980', hireDate: '1/1/2025' },
      {  name: 'محمود احمد',jobname:'مهندس ميكانيكى', mobil: '0564801220', email: 'm.ahmed@assar.sa', birthDate: '1/1/1998', hireDate: '1/1/2026' },
      {  name: 'مالك محمد',jobname:'مهندس اتصالات', mobil: '0564801550', email: 'm.malik@assar.sa', birthDate: '1/1/1999', hireDate: '1/1/2024' },
  ...
  */
    ...
    {
      const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/Employees/add/';
