...
@Component({
  selector: 'app-List-ContractType',
  templateUrl: './List-ContractType.component.html',
  styleUrls: ['./List-ContractType.component.css']
})
export class ListContractTypeComponent implements  OnInit {
   tableData = [
...
*/
  ...
  {
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/ContractType/list/';
  ...
  {
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/ContractType/add';
 ...
 edit(row: any) {
  ...
  ShowEdit(id:string)
  {
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/ContractType/edit/'+id;
