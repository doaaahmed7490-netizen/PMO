...
@Component({
  selector: 'app-Add-ContractType',
  templateUrl: './Add-ContractType.component.html',
  styleUrls: ['./Add-ContractType.component.css']
})
export class AddContractTypeComponent implements OnInit {
  ...
  */
   ...
   onSubmit()
 {
   const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/ContractType';
