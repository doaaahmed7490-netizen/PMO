...
export class ListPositionComponent implements  OnInit {
   tableData = [
    {  type: 'الرئيس التنفيذي', notes: 'مسؤول عن الإدارة العامة والاستراتيجية واتخاذ القرارات الرئيسية.' },
     {  type: 'مدير مكتب إدارة المشاريع', notes: 'مسؤول عن إدارة حوكمة المشاريع والمنهجيات ومتابعة الأداء.'  },
     {  type: 'مدير مشروع', notes: 'مسؤول عن تخطيط وتنفيذ ومتابعة المشروع.'  },
     {  type: 'مساعد مدير مشروع', notes: 'يساعد مدير المشروع في التنسيق والمتابعة وإعداد التقارير.'  },

     {  type: 'منسق مشاريع', notes: 'مسؤول عن تنسيق الاجتماعات ومتابعة المهام وتحديث بيانات المشروع.'  },
     {  type: 'مخطط مشاريع', notes: 'مسؤول عن إعداد ومتابعة الجدول الزمني وخطط المشروع.'  },
     {  type: 'مدير المخاطر', notes: 'مسؤول عن تحديد وتحليل ومتابعة مخاطر المشاريع.'  },
     {  type: 'مدير تطوير البرمجيات', notes: 'مسؤول عن إدارة فرق التطوير والأنظمة البرمجية.'  },
