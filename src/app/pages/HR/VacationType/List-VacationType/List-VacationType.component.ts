...
@Component({
  selector: 'app-List-VacationType',
  templateUrl: './List-VacationType.component.html',
  styleUrls: ['./List-VacationType.component.css']
})
export class ListVacationTypeComponent implements  OnInit {
   tableData = [
...
*/
  ...
  {
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/VacationType/list/';
  ...
  {
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/VacationType/add';
 ...
 edit(row: any) {
  ...
  ShowEdit(id:string)
  {
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/VacationType/edit/'+id;
