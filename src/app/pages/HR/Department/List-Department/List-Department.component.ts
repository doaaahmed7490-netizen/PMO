...
export class ListDepartmentComponent implements  OnInit {
   tableData = [
    {  type: 'الإدارة التنفيذية',manager:'احمد محمد', notes: 'إدارة الشركة واتخاذ القرارات الاستراتيجية والإشراف على جميع الإدارات.' },
     {  type: 'إدارة المشاريع',manager:'احمد محمد', notes: 'إدارة وتنفيذ المشاريع والتنسيق بين فرق العمل والعملاء.'  },
     {  type: 'إدارة تقنية المعلومات',manager:'محمود محمد', notes: 'إدارة الأنظمة التقنية والبنية التحتية والدعم الفني والتطوير التقني.'  },
     {  type: 'إدارة تطوير البرمجيات', manager:'محمود محمد',notes: 'تصميم وتطوير وصيانة التطبيقات والأنظمة البرمجية.'  },

     {  type: 'إدارة تحليل الأعمال', manager:'احمد محمد',notes: 'تحليل احتياجات العملاء وتحويل المتطلبات إلى وثائق ومتطلبات تقنية واضحة.'  },
     {  type: 'إدارة البنية التحتية', manager:'مالك محمد',notes: 'إدارة الخوادم والشبكات وقواعد البيانات والبيئات التقنية.'  },
     {  type: 'إدارة الموارد البشرية',manager:'مالك محمد', notes: 'إدارة الموظفين والتوظيف والإجازات والرواتب وتقييم الأداء.'  },
     {  type: 'إدارة المبيعات', manager:'مالك محمد',notes: 'تطوير الأعمال، البحث عن العملاء، وإدارة فرص البيع والعقود.'  },

     {  type: 'إدارة التسويق',manager:'احمد محمد', notes: 'التسويق للخدمات والمنتجات وإدارة الحملات والهوية التجارية.'  },
    
         {  type: 'إدارة العقود والمناقصات',manager:'احمد محمد', notes: 'إدارة المناقصات والعروض الفنية والمالية والعقود.'  },
...
*/
 ...
 edit(row: any) {
  ...
  ShowEdit(id:string)
  {
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/Department/edit/'+id;
