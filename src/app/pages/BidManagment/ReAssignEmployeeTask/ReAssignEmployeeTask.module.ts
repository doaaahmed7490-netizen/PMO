...
import { ReAssignEmployeeTaskRoutingModule } from './ReAssignEmployeeTask-routing.module';
...
ReAssignComponent    
  ...
  imports: [
    ReAssignEmployeeTaskRoutingModule,
    NbCardModule,
    NbButtonModule,
    NbInputModule,
    CommonModule,
...
export class ReAssignEmployeeTaskModule { }
