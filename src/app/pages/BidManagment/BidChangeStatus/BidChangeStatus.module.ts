...
import { BidChangeStatusRoutingModule } from './BidChangeStatus-routing.module';
...
@NgModule({
  ...
  declarations: [
   // ListBidComponent,
AddBidChangeStatusComponent    
  ],

  imports: [
    BidChangeStatusRoutingModule,
    NbCardModule,
    NbButtonModule,
    NbInputModule,
    CommonModule,
...
export class BidChangeStatusModule { }
