...
import { BidTasksWorkFlowRoutingModule } from './bidTasksWorkFlow-routing.module';
...
@NgModule({
  ...
  declarations: [
   // ListBidComponent,
AddBidTaskWorkFlowComponent    
  ],

  imports: [
    BidTasksWorkFlowRoutingModule,
    NbCardModule,
    NbButtonModule,
    NbInputModule,
    CommonModule,
...
export class BidTasksWorkFlowModule { }
