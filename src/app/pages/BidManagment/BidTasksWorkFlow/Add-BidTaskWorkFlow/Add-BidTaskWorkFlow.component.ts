...
@Component({
  selector: 'app-Add-BidTaskWorkFlow',
  templateUrl: './Add-BidTaskWorkFlow.component.html',
  styleUrls: ['./Add-BidTaskWorkFlow.component.css']
})
export class AddBidTaskWorkFlowComponent implements  OnInit {
  constructor(
