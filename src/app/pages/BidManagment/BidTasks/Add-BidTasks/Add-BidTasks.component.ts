...
@Component({
  selector: 'app-Add-BidTasks',
  templateUrl: './Add-BidTasks.component.html',
  styleUrls: ['./Add-BidTasks.component.css']
})
export class AddBidTasksComponent implements  OnInit {
  constructor(
