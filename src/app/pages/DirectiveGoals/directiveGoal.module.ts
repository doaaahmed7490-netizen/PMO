...
import { DirectiveGoalRoutingModule } from './directiveGoal-routing.module';
...
@NgModule({
 // declarations: [ListBlockLawsComponent, AddLetterTypeComponent, EditBlockLawComponent],
  declarations: [AddDirectiveGoalComponent, ListDirectiveGoalComponent, EditDirectiveGoalComponent,
    SliceWordsPipe],

  imports: [
    DirectiveGoalRoutingModule,
    NbCardModule,
    NbButtonModule,
    NbInputModule,
    CommonModule,
...
export class DirectiveGoalModule { }
